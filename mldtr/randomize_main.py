...
def randomize_data(input_folder, stat_mult, settings, seed):
    ...
    if settings[1][1] != 1:
        item_logic_chunk[1] = [[253, 15, 16, 2], [3010, 15, 16, 5], [3009, 15, 16, 17, 1, -1, 15, 16, 1, 5], [271, 15, 16, 17, 2, -1, 15, 16, 2, 5], [272, 15, 16, 17, 2, -1, 15, 16, 2, 5], [273, 15, 16, 17, 2, -1, 15, 16, 2, 5],
