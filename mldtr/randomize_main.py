...
def randomize_data(input_folder, stat_mult, settings, seed):
    with tqdm(total=2085, desc="Initializing...") as pbar:
        ...
        enemy_logic = [[13], [18, 15, 5, -1, 15, 6], [25, 15, 0], [27, 15, 0], [29, 15, 0],
                           ...
                           [58, 1], [59, 1], [60, 23, 1, -1, 1, 5], [61, 23, 1, -1, 1, 5],
        ...
        if settings[1][0] == 1 or settings[1][1] == 1:
            if settings[1][0] == 1 and settings[1][1] == 1:
                replace_enemy = [[41, 15, 16, 17, 2], [58, 23], [59, 23], [60, 23], [61, 23], [68, 15, 16], [69, 15, 16], [70, 15, 16], [71, 15, 16],
                ...
                replace_enemy = [[41, 15, 16, 5, -1, 15, 16, 17, 2], [58], [59, 23, -1, 5], [60, 23, -1, 5], [61, 23, -1, 5], [68, 15, 16], [69, 15, 16],
                ...
                replace_enemy = [[41, 15, 16, 17, 2], [58, 1], [59, 23, 1], [60, 23, 1], [61, 23, 1], [85, 15, -1, 23, 1, 4, 5], [86, 15, -1, 23, 1, 4, 5],
        ...
        if settings[1][0] != 1 and settings[1][1] != 1:
            ...
            item_logic_chunk[6] = [[1573, 1], [1574], [1575], [1576, 23, 0], [1577, 23, 0], [2554, 23, 0, 3], [1578, 23, 0, 3, -1, 23, 0, 5], [1579, 23, 2, 3],
                          ...
                          [2359, 23, 2, 4, 6, 8, 10], [2360, 23, 2, 4, 6, 8, 10], [2375, 23, 0, 4, 6, 8, 10], [1611, 0, 4, 5],
                          [1612, 23, 0, 4, 5], [1613, 23, 2, 4, 5], [1614, 23, 0, 4, 6, 8, 10], [1615, 23, 0, 4, 6, 8, 10], [2566, 23, 0, 4, 6, 8, 10], [1616, 23, 0, 4, 6, 8, 10],
                          [1617, 23, 0, 4, 6, 8, 10], [1618, 23, 2, 4, 6, 8, 10], [2361, 23, 2, 4, 6, 8, 10], [2362, 23, 0, 3, 5],
                          [1619, 23, 2, 4, 6, 8, 10], [1620, 23, 2, 4, 6, 8, 10], [1621, 23, 0, 3, 5], [2296, 23, 2, 3, 5], [1623, 23, 0, 3, 5],]
        elif settings[1][1] == 1:
