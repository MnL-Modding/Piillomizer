...
def randomize_data(input_folder, stat_mult, settings, seed):
    with tqdm(total=1574, desc="Initializing...") as pbar:
        ...
        with (
            ...
            if settings[1][1] == 1:
                ...
                for i in range(len(spot[1])):
                    parsed_fmapdat[0x5D][3][spot[1][i]] = 0x78
            ...
            rooms_to_init = [0x001, 0x004, 0x005, 0x010, 0x011, 0x012, 0x013, 0x014, 0x017, 0x019, 0x01F, 0x020, 0x021, 0x022, 0x027, 0x028, 0x02A,
                             0x034, 0x035, 0x036, 0x038, 0x039, 0x03A, 0x03B, 0x03D, 0x040, 0x04B, 0x04C, 0x04D, 0x04F,
        ...
        if settings[1][1] == 0:
            item_logic_chunk[13] = [[697, 15, 16, 22, 1, 2, 4, 5, 6], [700, 15, 16, 22, 1, 2, 4, 5, 6], [701, 15, 16, 22, 1, 2, 4, 5, 6], [726, 15, 16, 22, 1, 2, 4, 5, 6], [727, 15, 16, 22, 1, 2, 4, 5, 6],
                                    [728, 15, 16, 22, 1, 2, 4, 5, 6], [760, 15, 22, 0, 6], [761, 15, 22, 0, 6], [764, 15, 22, 2, 6], [765, 15, 16, 22, 1, 2, 4, 5, 6]]
        else:
            item_logic_chunk[13] = [[697, 15, 16, 17, 18, 19, 20, 21, 22, 23, 1, 2, 4, 5, 6], [700, 15, 16, 17, 18, 19, 20, 21, 22, 23, 1, 2, 4, 5, 6], [701, 15, 16, 17, 18, 19, 20, 21, 22, 23, 1, 2, 4, 5, 6],
