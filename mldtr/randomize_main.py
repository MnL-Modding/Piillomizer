    ...
    with tqdm(total=1574, desc="Initializing...") as pbar:
        ...
        with (
            ...
            rooms_to_init = [0x001, 0x004, 0x005, 0x010, 0x011, 0x012, 0x013, 0x014, 0x017, 0x019, 0x01F, 0x020, 0x021, 0x022, 0x027, 0x028, 0x02A,
                             ...
                             0x06D, 0x06F, 0x070, 0x072, 0x075, 0x076, 0x079, 0x07C, 0x0BB, 0x0BD, 0x0BE, 0x0C4, 0x0C5, 0x0C6, 0x0E4, 0x0F5, 0x0F6,
                             0x0FA, 0x10C, 0x124, 0x125, 0x126, 0x127, 0x128, 0x129, 0x12A, 0x13D, 0x144, 0x145, 0x146, 0x147, 0x148, 0x14B, 0x14C,
                             0x14E, 0x14F, 0x177, 0x17A, 0x17D, 0x1E7, 0x1F8, 0x295,]
        ...
        if settings[1][1] == 0:
            item_logic_chunk[10] = [[2577, 15, 16, 17, 18, 19, 20, 21, 6, 8, 9, -1, 15, 16, 5, 6, 8, 9], [568, 16, 17, 18, 19, 20, 21, 6, 9, -1, 16, 5, 6, 9], [569, 16, 17, 18, 19, 20, 21, 6, 9, -1, 16, 5, 6, 9], [577, 16, 4, 5, 6], [578, 16, 4, 5, 6], [579, 16, 4, 5, 6], [580, 16, 4, 5, 6],
            ...
            item_logic_chunk[10] = [[2577, 15, 16, 17, 18, 19, 20, 21, 6, 8, 9], [568, 16, 17, 18, 19, 20, 21, 6, 9], [569, 16, 17, 18, 19, 20, 21, 6, 9], [577, 16, 4, 5, 6], [578, 16, 4, 5, 6], [579, 16, 4, 5, 6], [580, 16, 4, 5, 6],
        ...
        if settings[1][1] == 0 and settings[1][0] == 0:
            ...
            item_logic_chunk[14] = [[36, 15, 5], [37, 15, 5], [38, 15, 5], [39, 15, 5], [40, 15, 5], [319, 15, 16, 17, 18, 19, 20, 21, 1, 5], [320, 15, 16, 17, 18, 19, 20, 21, 1, 5],
                                    ...
                                    [46, 15, 5, -1, 15, 6], [47, 15, 5, -1, 15, 6], [2591, 15, 16, 0, 6], [879, 23, 3, 6, -1, 23, 5, 6], [880, 23, 3, 6, -1, 23, 5, 6]]
        if settings[1][0] == 0:
            item_logic_chunk[15] = [[1630, 27, 1, 5], [1631, 27, 1, 3, 5], [2592, 27, 1, 3, 5], [2593, 27, 1, 3, 5], [2594, 27, 1, 3, 5], [1632, 27, 1, 5], [1633, 27, 1, 5], [2595, 27, 1, 5], [2596, 27, 1, 5], [1634, 27, 1, 5], [2597, 27, 1, 3, 5], [2598, 27, 1, 5], [1635, 27, 1, 5],
                                    [2599, 27, 1, 3, 5], [2600, 27, 1, 5], [2601, 27, 1, 3, 5, 6], [1636, 27, 1, 3, 5, 6], [1637, 27, 1, 3, 5, 6], [1638, 27, 1, 3, 5, 6], [1639, 27, 1, 2, 3, 5, 6], [280, 27, 1, 3, 5, 6], [322, 27, 1, 3, 5, 6], [1640, 27, 1, 2, 3, 5, 6], [1641, 27, 1, 2, 3, 5, 6],
                                    [1642, 27, 1, 3, 5, 6], [2602, 27, 1, 3, 5, 6], [2603, 27, 1, 3, 5, 6], [2363, 27, 1, 3, 5, 6], [2364, 27, 1, 3, 5, 6], [2365, 27, 1, 3, 5, 6], [2366, 27, 1, 3, 5, 6], [2367, 27, 1, 3, 5, 6], [2604, 27, 1, 3, 5, 6], [2605, 27, 1, 3, 5, 6], [1646, 27, 1, 3, 5, 6], [1647, 27, 1, 3, 5, 6], [1648, 27, 1, 2, 3, 5, 6],
                                    [1649, 27, 1, 2, 3, 5, 6], [2606, 27, 1, 3, 5, 6], [2405, 27, 1, 3, 5, 6], [2406, 27, 1, 3, 5, 6], [2407, 27, 1, 3, 5, 6], [2607, 27, 1, 3, 5, 6], [1651, 27, 1, 3, 5, 6], [1652, 27, 1, 3, 5, 6], [2297, 27, 1, 3, 5, 6], [2298, 27, 1, 3, 5, 6],
                                    [1655, 27, 1, 3, 5, 6], [1656, 27, 1, 3, 5, 6], [1657, 27, 1, 3, 5, 6], [1658, 27, 1, 3, 5, 6], [1659, 27, 1, 2, 3, 5, 6], [1660, 27, 1, 2, 3, 5, 6], [1661, 27, 1, 2, 3, 5, 6], [1662, 27, 1, 2, 3, 5, 6], [2377, 27, 1, 3, 5, 6], [2378, 27, 1, 3, 5, 6], [2379, 27, 1, 3, 5, 6],
                                    [1663, 27, 1, 3, 5, 6], [1664, 27, 1, 3, 5, 6], [2380, 27, 1, 3, 5, 6], [2381, 27, 1, 3, 5, 6], [1665, 27, 1, 3, 5, 6], [1666, 27, 1, 3, 5, 6], [1667, 27, 1, 3, 5, 6], [2354, 27, 1, 2, 3, 5, 6], [1668, 27, 1, 3, 5, 6], [1669, 27, 1, 2, 3, 5, 6],
                                    [1670, 27, 1, 3, 5, 6], [1671, 27, 1, 2, 3, 5, 6], [1672, 27, 1, 3, 5, 6], [2408, 27, 1, 2, 3, 5, 6], [2409, 27, 1, 2, 3, 5, 6], [1673, 27, 1, 4, 5, 6], [1674, 27, 1, 4, 5, 6], [1675, 27, 1, 4, 5, 6], [1676, 27, 1, 2, 4, 5, 6], [1677, 27, 1, 2, 4, 5, 6], [1678, 27, 1, 4, 5, 6], [1679, 27, 1, 2, 4, 5, 6]]
        else:
            item_logic_chunk[15] = [[1630, 27, 5], [1631, 27, 3, 5], [2592, 27, 3, 5], [2593, 27, 3, 5], [2594, 27, 3, 5], [1632, 27, 5], [1633, 27, 5], [2595, 27, 5], [2596, 27, 5], [1634, 27, 5], [2597, 27, 3, 5], [2598, 27, 5], [1635, 27, 5], [2599, 27, 3, 5], [2600, 27, 5],
                                    [2601, 27, 1, 3, 5, 6], [1636, 27, 1, 3, 5, 6], [1637, 27, 1, 3, 5, 6], [1638, 27, 1, 3, 5, 6], [1639, 27, 2, 3, 5, 6], [280, 27, 3, 5, 6], [322, 27, 3, 5, 6], [1640, 27, 2, 3, 5, 6], [1641, 27, 2, 3, 5, 6], [1642, 27, 3, 5, 6], [2602, 27, 3, 5, 6], [2603, 27, 3, 5, 6],
                                    [2363, 27, 3, 5, 6], [2364, 27, 3, 5, 6], [2365, 27, 3, 5, 6], [2366, 27, 3, 5, 6], [2367, 27, 3, 5, 6], [2604, 27, 3, 5, 6], [1646, 27, 3, 5, 6], [1647, 27, 3, 5, 6], [1648, 27, 3, 5, 6], [1649, 27, 3, 5, 6], [2606, 27, 3, 5, 6], [2405, 27, 3, 5, 6], [2406, 27, 3, 5, 6],
                                    [2407, 27, 3, 5, 6], [2607, 27, 0, 3, 5, 6], [1651, 27, 0, 3, 5, 6], [1652, 27, 0, 3, 5, 6], [2297, 27, 0, 3, 5, 6], [2298, 27, 0, 3, 5, 6], [1655, 27, 0, 3, 5, 6], [1656, 27, 0, 3, 5, 6], [1657, 27, 0, 3, 5, 6], [1658, 27, 3, 5, 6], [1659, 27, 2, 3, 5, 6],
                                    [1660, 27, 2, 3, 5, 6], [1661, 27, 2, 3, 5, 6], [1662, 27, 2, 3, 5, 6], [2337, 27, 0, 3, 5, 6], [2338, 27, 0, 3, 5, 6], [2339, 27, 0, 3, 5, 6], [1663, 27, 0, 3, 5, 6], [1664, 27, 0, 3, 5, 6], [2380, 27, 0, 3, 5, 6], [2381, 27, 0, 3, 5, 6],
                                    [1665, 27, 0, 3, 5, 6], [1666, 27, 0, 3, 5, 6], [1667, 27, 0, 3, 5, 6], [2354, 27, 2, 3, 5, 6], [1668, 27, 0, 3, 5, 6], [1669, 27, 2, 3, 5, 6], [1670, 27, 0, 3, 5, 6], [1671, 27, 2, 3, 5, 6], [1672, 27, 0, 3, 5, 6], [2408, 27, 2, 3, 5, 6],
                                    [2409, 27, 2, 3, 5, 6], [1673, 27, 1, 3, 5, 6], [1674, 27, 1, 3, 5, 6], [1675, 27, 0, 3, 5, 6], [1676, 27, 2, 3, 5, 6], [1677, 27, 2, 3, 5, 6], [1678, 27, 0, 3, 5, 6], [1679, 27, 2, 3, 5, 6]]
