...
def randomize_data(input_folder, stat_mult, settings, seed):
    ...
    if settings[1][1] != 1:
        ...
        item_logic_chunk[1] = [[253, 15, 16, 2], [271, 15, 16, 17, 2], [272, 15, 16, 17, 2], [273, 15, 16, 17, 2],
                      ...
                      [277, 15, 16, 17], [278, 15, 16, 17], [279, 15, 16, 2], [281, 15, 16, 2], [282, 15, 16, 1], [283, 15, 16, 17],
    ...
    attack_piece_info = [[0x0040], [0x0041], [0x0042], [0x0043], [0x0050], [0x0051], [0x0052], [0x0053], [0x0100], [0x0110], [0x0120], [0x0130],
                         [0x0140], [0x0170], [0x0190], [0x0191], [0x0620]]

    attack_piece_logic = [[0x0040, 15, 0], [0x0041, 15, 0], [0x0042, 15, 0], [0x0043, 15, 0],
                         [0x0050, 15, 0], [0x0051, 15, 0], [0x0052, 15, 0], [0x0053, 15, 0],
                          [0x0100, 16, 17, 2, -1, 16, 2, 5], [0x0110], [0x0120, 16, 1], [0x0130, 16, 17, 1, -1, 16, 1, 5],
