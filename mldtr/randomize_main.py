    ...
    with tqdm(total=2089, desc="Initializing...") as pbar:
        ...
        if settings[1][1] != 1:
            ...
            item_logic_chunk[1] = [[253, 15, 16, 2], [2509, 15, 16, 17, 1], [2510, 15, 16, 17, 1, 5], [271, 15, 16, 17, 2], [272, 15, 16, 17, 2], [273, 15, 16, 17, 2],
                          ...
                          [312, 15, 16, 17, 1], [2374, 15, 16, 17, 1, 5, -1, 15, 16, 17, 2, 5], [313, 15, 16, 17, 18, 19, 20, 21, 3, 5], [314, 15, 16, 17, 18, 19, 20, 21, 3, 5], [15], [16, 2]]
        ...
        if settings[1][0] != 1:
            item_logic_chunk[3] = [[1511, 15, 3], [1512, 15, 2, 3], [1513, 15, 2, 3], [2532, 15, 22], [1514, 15, 22], [1515, 15, 22, 2], [2533, 15, 22], [2534, 15, 22],
                      ...
                      [2400, 15, 16, 1, 2, 4], [1558, 15, 16, 1, 3], [2549, 15, 16, 1, 3], [2550, 15, 16, 1, 3], [2551, 15, 16, 1, 4], [1559, 15, 16, 1, 3], [1560, 15, 16, 1, 2, 3],
            ...
            item_logic_chunk[3] = [[1511, 15, 3], [1512, 15, 2, 3], [1513, 15, 2, 3], [2532, 15, 22], [1514, 15, 22], [1515, 15, 22, 2],
                          ...
                          [1528, 15, 22], [1529, 15, 22], [1530, 15, 22], [1531, 15, 22], [1532, 15, 22], [2540, 15, 16], [2541, 15, 16, 0, 4], [2542, 15, 16, 0, 3, -1, 15, 16, 0, 5], [1553, 15, 16],
                          [1554, 15, 16, 0, 3],
                          [2331, 15, 16, 3], [2332, 15, 16, 3], [2543, 15, 16, 0, 3], [1562, 15, 16, 0, 3], [1539, 15, 22, 3], [2538, 15, 22], [1540, 15, 22],
                          [1541, 15, 22], [1542, 15, 22], [2539, 15, 22], [2540, 15, 22], [1566, 15, 16, 0, 3], [1567, 15, 16, 0, 3], [1568, 15, 16, 0, 3],
                          [1569, 15, 16, 0, 3], [1570, 15, 16, 0, 3, 5], [1571, 15, 16, 2, 3],
                          [1572, 15, 16, 2, 3], [1543, 15, 16, 1], [1544, 15, 16, 1], [1545, 15, 16, 1], [2398, 15, 16, 1],
                          [2547, 15, 16, 4, -1, 15, 16, 5], [2399, 15, 16],
                          [1547, 15, 16], [1548, 15, 16, 2], [2548, 15, 16, 4], [1555, 15, 16, 0, 4], [1556, 15, 16, 0, 4], [1557, 15, 16, 2, 4],
                          [2400, 15, 16, 2, 4], [1558, 15, 16, 0, 3], [2549, 15, 16, 0, 3], [2550, 15, 16, 0, 3], [2551, 15, 16, 0, 4], [1559, 15, 16, 0, 3], [1560, 15, 16, 2, 3],
                          [1561, 15, 16, 2, 3], [2401, 15, 16, 2, 3], [2552, 15, 16, 1, 4], [1563, 15, 16, 0, 4, -1, 15, 16, 3, 5],
                          [1564, 15, 16, 0, 4, -1, 15, 16, 3, 5], [1565, 15, 16, 2, 4, -1, 15, 16, 2, 4, 5],
        ...
        if settings[1][0] != 1 and settings[1][1] != 1:
            ...
            item_logic_chunk[6] = [[1573, 1], [1574], [1575], [1576, 23, 0], [1577, 23, 0], [2554, 23, 0, 3], [1578, 23, 0, 3, -1, 23, 0, 5], [1579, 23, 2, 3],
                          [1580, 23, 2, 3], [2555, 23, 1], [1581, 23, 0], [1582, 23, 0], [1583, 23, 2, 4], [2402, 23, 2, 4],
                          [2542, 23, 0], [2543, 23, 0, 3], [1584, 23, 0], [1585, 23, 2, 3], [1586, 23, 0, 3], [2558, 23, 0], [1587, 23, 0, 3], [1588, 23, 0],
                          [1589, 23, 0], [1590, 23, 0], [1591, 23, 2, 3], [1592, 23, 0, 3], [2403, 23, 0, 3, -1, 23, 0, 5], [2559, 23, 0, 3],
                          [1593, 23, 2, 3], [2560, 23, 0, 3], [1594, 23, 2, 3], [1595, 23, 0, 3, 6], [1596, 23, 0, 3],
                          [1597, 23, 0, 3], [2561, 23, 0, 3], [2562, 23, 0, 3], [1598, 23, 0, 3, 5], [1599, 23, 0, 3, 5], [2333, 23, 0, 3], [1546, 23, 0, 3], [2219, 23, 0, 3],
                          [1600, 23, 0, 2, 3], [1601, 23, 0, 2, 3], [2334, 23, 0, 2, 3], [2544, 23, 0, 3, 6, 8], [1602, 23, 0, 4, 6, 8, 10], [2564, 23, 0, 4, 6, 8, 10],
                          [1603, 23, 0, 4, 6, 8, 10], [1604, 23, 0, 4, 6, 8, 10], [1605, 23, 0, 4, 6, 8, 10], [1606, 0, 23, 4, 6, 8, 10],
                          [1607, 23, 2, 4, 6, 8, 10], [1608, 23, 0, 4, 6, 8, 10], [2565, 23, 0, 4, 6, 8, 10], [1609, 23, 0, 4, 6, 8, 10], [1610, 23, 0, 4, 6, 8, 10],
                          [2359, 23, 2, 4, 6, 8, 10], [2360, 23, 2, 4, 6, 8, 10], [2375, 23, 0, 4, 6, 8, 10], [1611, 0, 4, 5, 6, 8, 10],
                          [1612, 23, 0, 4, 5, 6, 8, 10], [1613, 23, 2, 4, 5, 6, 8, 10], [1614, 23, 0, 4, 6, 8, 10], [1615, 23, 0, 4, 6, 8, 10], [2566, 23, 0, 4, 6, 8, 10], [1616, 23, 0, 4, 6, 8, 10],
                          [1617, 23, 0, 4, 6, 8, 10], [1618, 23, 2, 4, 6, 8, 10], [2361, 23, 2, 4, 6, 8, 10], [2362, 23, 0, 4, 5, 6, 8, 10],
                          [1619, 23, 2, 4, 6, 8, 10], [1620, 23, 2, 4, 6, 8, 10], [1621, 23, 0, 3, 5, 6, 8, 10], [2296, 23, 2, 4, 5, 6, 8, 10], [1623, 23, 2, 4, 5, 6, 8, 10],]
        elif settings[1][1] == 1:
            item_logic_chunk[6] = [[1573, 1], [1574, 1], [1575, 1], [1576, 23, 1], [1577, 23, 1], [2554, 23, 1, 3], [1578, 23, 1, 3, -1, 1, 23, 5], [1579, 23, 1, 2, 3],
                          ...
                          [2359, 23, 1, 2, 4, 6, 8, 10], [2360, 23, 1, 2, 4, 6, 8, 10], [2375, 23, 1, 4, 6, 8, 10], [1611, 23, 1, 4, 5, 6, 8, 10],
                          [1612, 23, 1, 4, 5, 6, 8, 10], [1613, 23, 1, 4, 5, 6, 8, 10], [1614, 23, 1, 4, 6, 8, 10], [1615, 23, 1, 4, 6, 8, 10], [2566, 23, 1, 4, 6, 8, 10], [1616, 23, 1, 4, 6, 8, 10],
                          [1617, 23, 1, 4, 6, 8, 10], [1618, 23, 1, 2, 4, 6, 8, 10], [2361, 23, 1, 2, 4, 6, 8, 10], [2362, 23, 1, 4, 5, 6, 8, 10],
                          [1619, 23, 1, 2, 4, 6, 8, 10], [1620, 23, 1, 2, 4, 6, 8, 10], [1621, 23, 1, 2, 4, 5, 6, 8, 10], [2296, 23, 1, 2, 4, 5, 6, 8, 10], [1623, 23, 1, 2, 4, 5, 6, 8, 10],]
        else:
            item_logic_chunk[6] = [[1573, 1], [1574], [1575], [1576, 23, 0, -1, 0, 5], [1577, 23, 0, -1, 0, 5], [2554, 23, 0, 3, -1, 0, 3, 5], [1578, 23, 0, 3, -1, 0, 5], [1579, 23, 2, 3, -1, 2, 3, 5],
                          [1580, 23, 2, 3, -1, 2, 3, 5], [2555, 23, 1, -1, 1, 5], [1581, 23, 0, -1, 0, 5], [1582, 23, 0, -1, 0, 5], [1583, 23, 2, 4, -1, 2, 4, 5], [2402, 23, 2, 4, -1, 2, 4, 5],
                          [2542, 23, 0, -1, 0, 5], [2543, 23, 0, 3, -1, 0, 3, 5], [1584, 23, 0, -1, 0, 5], [1585, 23, 2, 3, -1, 2, 3, 5], [1586, 23, 0, 3, -1, 0, 5], [2558, 23, 0, -1, 0, 5], [1587, 23, 0, 3, -1, 0, 3, 5], [1588, 23, 0, -1, 0, 5],
                          [1589, 23, 0, -1, 0, 5], [1590, 23, 0, -1, 0, 5], [1591, 23, 2, 3, -1, 2, 3, 5], [1592, 23, 0, 3, -1, 0, 3, 5], [2403, 23, 0, 3, -1, 0, 5], [2559, 23, 0, 3, -1, 0, 3, 5],
                          [1593, 23, 2, 3, -1, 2, 3, 5], [2560, 23, 0, 3, -1, 0, 3, 5], [1594, 23, 2, 3, -1, 2, 3, 5], [1595, 23, 0, 3, 6, -1, 0, 3, 5, 6], [1596, 23, 0, 3, -1, 0, 3, 5],
                          [1597, 23, 0, 3, -1, 0, 3, 5], [2561, 23, 0, 3, -1, 0, 3, 5], [2562, 23, 0, 3, -1, 0, 3, 5], [1598, 0, 3, 5], [1599, 0, 3, 5], [2333, 23, 0, 3, -1, 0, 3, 5], [1546, 23, 0, 3, -1, 0, 3, 5], [2219, 23, 0, 3, -1, 0, 3, 5],
                          [1600, 23, 2, 3, -1, 2, 3, 5], [1601, 23, 2, 3, -1, 2, 3, 5], [2334, 23, 2, 3, -1, 2, 3, 5], [2544, 23, 0, 3, 6, 8, -1, 0, 3, 5, 6, 8], [1602, 23, 0, 4, 6, 8, 10, -1, 0, 4, 5], [2564, 23, 0, 4, 6, 8, 10, -1, 0, 4, 5],
                          [1603, 23, 0, 4, 6, 8, 10, -1, 0, 4, 5], [1604, 23, 0, 4, 6, 8, 10, -1, 0, 4, 5, 6], [1605, 23, 0, 4, 6, 8, 10, -1, 0, 4, 5], [1606, 23, 0, 4, 6, 8, 10, -1, 0, 5],
                          [1607, 23, 2, 4, 6, 8, 10, -1, 2, 5], [1608, 23, 0, 4, 6, 8, 10, -1, 0, 4, 5], [2545, 23, 0, 4, 6, 8, 10, -1, 0, 4, 5], [1609, 23, 0, 4, 6, 8, 10, -1, 0, 4, 5], [1610, 23, 0, 4, 6, 8, 10, -1, 0, 4, 5],
                          [2359, 23, 2, 4, 6, 8, 10, -1, 2, 4, 5], [2360, 23, 2, 4, 6, 8, 10, -1, 2, 4, 5], [2375, 23, 0, 4, 6, 8, 10, -1, 0, 4, 5], [1611, 0, 4, 5],
                          [1612, 0, 4, 5], [1613, 2, 4, 5], [1614, 23, 0, 4, 6, 8, 10, -1, 0, 4, 5], [1615, 23, 0, 4, 6, 8, 10, -1, 0, 4, 5], [2566, 23, 0, 4, 6, 8, 10, -1, 0, 4, 5], [1616, 23, 0, 4, 6, 8, 10, -1, 0, 4, 5],
                          [1617, 23, 0, 4, 6, 8, 10, -1, 0, 4, 5], [1618, 23, 2, 4, 6, 8, 10, -1, 2, 4, 5], [2361, 23, 2, 4, 6, 8, 10, -1, 2, 4, 5], [2362, 0, 3, 5],
        ...
        if settings[1][1] == 0:
            ...
            [2570, 15, 16, 17, 18, 19, 20, 21, 6], [2571, 15, 16, 17, 18, 19, 20, 21, 6], [512, 16, 17, 18, 19, 20, 21, 6], [513, 16, 17, 18, 19, 20, 21, 6],
